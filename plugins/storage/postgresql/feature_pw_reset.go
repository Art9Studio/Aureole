...
func (s *Storage) GetReset(spec *collections.Spec, filters []types.Filter) (types.JSONCollResult, error) {
...
func (s *Storage) InvalidateReset(spec *collections.Spec, filters []types.Filter) error {
