...
func (f *authn) Init(api core.PluginAPI) (err error) {
	f.pluginAPI = api
...
func (f *authn) GetHandlersSpec() (*spec.Paths, spec.Definitions) {
	return f.swagger.Paths, f.swagger.Definitions
}

func (f *authn) LoginWrapper() plugins.AuthNLoginFunc {
...
func initProvider(f *authn) error {
