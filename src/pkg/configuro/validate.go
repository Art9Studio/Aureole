...
// Validatable Any Plugin that Implements this interface will have its WithValidateByTags() function called when validating config.
...
func recursiveValidate(obj interface{}, recursive, returnOnFirstErr bool) error {
